...
const RegistrationPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Registration Details:', { name, email, password, mobile });
  };
      ...
      <div className="max-w-md w-full bg-white p-8 rounded shadow-lg">
        ...
        {!isRegistered ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="mobile" className="block text-sm font-semibold text-gray-600">Mobile Number</label>
              <input
                type="text"
                id="mobile"
                className="w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-indigo-500"
